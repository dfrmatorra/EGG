...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            switch (opc) {
                case 1:
                    System.out.println("---Listar aquellas familias que tienen al menos 3 hijos, y con edad máxima inferior a 10 años.---");
                    fs.imprimirFamilias(2);
                    System.out.println("----------");
                    break;
                    
                case 2:
                    System.out.println("---Buscar y listar las casas disponibles para el periodo comprendido entre el 1 de agosto de\n" +
                    "2020 y el 31 de agosto de 2020 en Reino Unido.---");
                    cs.imprimirCasas(2);
                    System.out.println("----------");
                    break;
